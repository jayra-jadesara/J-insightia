...
const ActivistShorts = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.activistShortNews) {
      setNewsIds(props.activistShortNews.map((c) => c.news_id));
    }
  }, [query.newsID, getAll, isOpenedOn, props.activistShortNews, newsDetailsArray.length]);
        ...
        <div className='col-xs-12 col-sm-12 col-lg-9 col-xl-9 p-0 position-reliatve'>
          {query.newsID !== undefined && isOpenedOn ? (
            ...
            <MultiNewsComponent
              ...
              staticPathConst={PathsConstant.NEWS_ACTIVIST_SHORT}
...
ActivistShorts.propTypes = {
  activistShortNews: PropTypes.array
};
