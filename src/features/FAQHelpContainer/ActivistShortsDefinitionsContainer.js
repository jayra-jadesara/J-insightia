...
import ActivistShortsDefinitions from '../../components/FAQ/ActivistShorts/definitions';
import {
...
const ActivistShortsDefinitionsContainer = ({
  location,
  handleResetHasRecord,
  getdata_FAQS_definitionReq,
  handleResetLoading,
  ...
  return (
    <ErrorBoundary>
      <ActivistShortsDefinitions {...props} />
    </ErrorBoundary>
  );
};

ActivistShortsDefinitionsContainer.propTypes = {
...
export default withRouter(
  connect(
    mapStateToProps,
    mapDispatchToProps
  )(ActivistShortsDefinitionsContainer)
);
