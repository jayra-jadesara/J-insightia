...
import RemunerationCommiteeMemberSearchTool from '../../../components/Tools/CompensationTools/RemunerationCommiteeMemberSearchTools/RemunerationCommiteeMemberSearchTool';

const RemunerationCommiteeMemberSearchContainer = ({
  token,
  ...
  return (
    <ErrorBoundary>
      <RemunerationCommiteeMemberSearchTool />
    </ErrorBoundary>
  );
};

RemunerationCommiteeMemberSearchContainer.propTypes = {
...
RemunerationCommiteeMemberSearchContainer.defaultProps = {
  HoldingsDataAndAnalyticsListReq: () => {},
  allowDownload: false,
  getProcedureRunningEstimateTimeReq: () => {},
  isLoading: false,
...
export default connect(mapStateToProps, mapDispatchToProps)(RemunerationCommiteeMemberSearchContainer);
