...
FAQ_GovernanceHeader.propTypes = {
...
FAQ_GovernanceHeader.defaultProps = {
  handleHoverSubmenu: () => {},
...
export default withRouter(React.memo(FAQ_GovernanceHeader));
