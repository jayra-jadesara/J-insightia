...
const Voting = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.votingNews) {
      setNewsIds(props.votingNews.map((c) => c.news_id));
    }
  }, [query.newsID, getAll, isOpenedOn, props.votingNews, newsDetailsArray.length]);
        ...
        <div className='col-xs-12 col-sm-12 col-lg-9 col-xl-9 p-0 position-reliatve'>
          {query.newsID !== undefined && isOpenedOn ? (
            ...
            <MultiNewsComponent
              ...
              staticPathConst={PathsConstant.NEWS_VOTING}
