...
import SayOnPayVoteResultsTool from '../../../components/Tools/CompensationTools/SayOnPayVoteResultsTools/SayOnPayVoteResultsTool';

const SayOnPayVoteResultsContainer = ({
  token,
  ...
  return (
    <ErrorBoundary>
      <SayOnPayVoteResultsTool />
    </ErrorBoundary>
  );
};

SayOnPayVoteResultsContainer.propTypes = {
...
SayOnPayVoteResultsContainer.defaultProps = {
  HoldingsDataAndAnalyticsListReq: () => {},
  allowDownload: false,
  getProcedureRunningEstimateTimeReq: () => {},
  isLoading: false,
...
export default connect(mapStateToProps, mapDispatchToProps)(SayOnPayVoteResultsContainer);
