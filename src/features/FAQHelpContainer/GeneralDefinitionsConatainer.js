...
import GeneralDefinitions from '../../components/FAQ/General/definitions';
import {
...
const GeneralDefinitionsContainer = ({
  location,
  handleResetHasRecord,
  getdata_FAQS_definitionReq,
  handleResetLoading,
  ...
  return (
    <ErrorBoundary>
      <GeneralDefinitions {...props} />
    </ErrorBoundary>
  );
};

GeneralDefinitionsContainer.propTypes = {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(GeneralDefinitionsContainer)
);
