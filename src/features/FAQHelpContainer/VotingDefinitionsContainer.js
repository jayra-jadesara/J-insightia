...
import VotingDefinitions from '../../components/FAQ/Voting/definitions';
import {
...
const VotingDefinitionsContainer = ({
  location,
  handleResetHasRecord,
  getdata_FAQS_definitionReq,
  handleResetLoading,
  ...
  return (
    <ErrorBoundary>
      <VotingDefinitions {...props} />
    </ErrorBoundary>
  );
};

VotingDefinitionsContainer.propTypes = {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(VotingDefinitionsContainer)
);
